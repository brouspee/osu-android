...
namespace osu.Game.Rulesets.Osu.Objects
{
    public abstract class OsuHitObject : HitObject, IHasComboInformation, IHasPosition, IHasTimePreempt
    {
        ...
        /// </summary>
        public const float OBJECT_RADIUS = 55;
        ...
        protected override void ApplyDefaultsToSelf(ControlPointInfo controlPointInfo, IBeatmapDifficultyInfo difficulty)
        {
            ...
            // MODDED: Force minimum scale of 1.5 regardless of Circle Size setting for bigger circles + hitboxes
            Scale = Math.Max(LegacyRulesetExtensions.CalculateScaleFromCircleSize(difficulty.CircleSize, true), 1.5f);
        }
